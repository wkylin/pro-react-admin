...
const About = () => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center border-b border-gray-800/50 px-4 py-5 text-center tracking-widest md:px-8 lg:px-16">
