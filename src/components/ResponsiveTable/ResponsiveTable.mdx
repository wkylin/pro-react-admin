...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <code>string | ((record: T) => React.Key)?</code>
      </td>
      <td>
        <code>'id'</code>
      </td>
    ...
    <tr>
      ...
      <td>
        <code>{`{ current: number; pageSize: number }?`}</code>
      </td>
      <td>
        <code>{`{ current: 1, pageSize: 10 }`}</code>
      </td>
      <td>初始分页配置。</td>
    </tr>
    <tr>
      <td>
        <code>minBodyHeight</code>
      </td>
      <td>
        <code>number?</code>
      </td>
    ...
    <tr>
      ...
      <td>
        <code>Array&lt;'view' | 'edit' | 'delete' | ActionConfig&lt;T&gt;&gt;?</code>
      </td>
      <td>
        <code>['view', 'edit', 'delete']</code>
      </td>
      <td>操作列配置。</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <code>null | 'multiple' | 'single'?</code>
      </td>
      <td>
        <code>null</code>
      </td>
    ...
    <tr>
      ...
      <td>
        <code>((page: number, pageSize: number, sort?: any, extraParams?: any) => Promise&lt;any&gt;)?</code>
      </td>
      <td>
        <code>null</code>
      </td>
