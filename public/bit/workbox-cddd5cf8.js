define('./workbox-cddd5cf8.js', ['exports'], function (t) {
  'use strict'
  try {
  ...
  class L {
    ...
    async cachePut(t, e) {
        ...
        f = l
          ? await (async function (t, e, s, n) {
              ...
              const i = Object.assign(Object.assign({}, n), { ignoreSearch: !0 }),
                o = await t.keys(e, i)
              for (const e of o) if (r === v(e.url, s)) return t.match(e, n)
      ...
      for (const t of this.iterateCallbacks('cacheDidUpdate'))
        await t({ cacheName: a, oldResponse: f, newResponse: c.clone(), request: i, event: this.event })
      return !0
    }
    async getCacheKey(t, e) {
      if (!this.u[e]) {
        ...
        for (const t of this.iterateCallbacks('cacheKeyWillBeUsed'))
          s = b(await t({ mode: e, request: s, event: this.event, params: this.params }))
        this.u[e] = s
      }
      return this.u[e]
    }
  ...
  class E extends class {
    ...
    async q(t, e, n) {
      ...
      try {
        if (((r = await this.L(e, t)), !r || 'error' === r.type)) throw new s('no-response', { url: e.url })
      } catch (s) {
  ...
  class x {
    ...
    addToCacheList(t) {
      ...
      for (const n of t) {
        ...
        const { cacheKey: t, url: r } = p(n),
          i = 'string' != typeof n && n.revision ? 'reload' : 'default'
        if (this.k.has(r) && this.k.get(r) !== t)
          throw new s('add-to-cache-list-conflicting-entries', { firstEntry: this.k.get(r), secondEntry: t })
  ...
  ;(t.NavigationRoute = class extends r {
    constructor(t, { allowlist: e = [/./], denylist: s = [] } = {}) {
      super((t) => this.K(t), t), (this.M = e), (this.P = s)
    }
    K({ url: t, request: e }) {
